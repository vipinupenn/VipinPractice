@Test
      ...
      Scenario Outline: Getting json place holder users
        ...
        Then I verifying the response results with name <Name>, User Name <UserName>, Email <Email>, Street <Street>, Zip Code <ZipCode>, City <City>
      ...
      Scenario Outline: Getting json place holder comments
         ...
         Then I verifying the response results of Comments with name <Name>, Email <Email>
      ...
      Scenario Outline: Creating json place holder Posts
        ...
        Then I verifying the response with id <Id>, title <Title>, body <Body>, userId <User Id>
